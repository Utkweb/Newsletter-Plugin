        ...
        if (loading) {
            ...
            return userArray.map(({_id, fname, email})=>(
                <tr key={_id}>
                    ...
                    <td>{email}</td>
                    <td>
                        <Button className='btn btn-primary' onClick={e => updateUser({_id, fname, email})}> <i class="fas fa-pen-nib"></i></Button>
                    </td>
                    <td>
                        <Button className='btn btn-danger' onClick={e => deleteUser(_id)}><i class="fas fa-trash"></i>  </Button>
                    </td>
                </tr>
            ))
        }
